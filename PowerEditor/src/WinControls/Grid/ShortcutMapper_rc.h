...
#define IDM_BABYGRID_MOVE_UP        (IDD_SHORTCUTMAPPER_DLG + 10)
#define IDM_BABYGRID_MOVE_DOWN      (IDD_SHORTCUTMAPPER_DLG + 11)
#define IDM_BABYGRID_SORT           (IDD_SHORTCUTMAPPER_DLG + 12)
